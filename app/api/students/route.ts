...
export async function GET(req: Request) {
  ...
  const students = await prisma.student.findMany({
    ...
    select: { id: true, name: true, username: true, avatar: true, approved: true, isEnrolled: true, parentName: true, parentPhone: true, createdAt: true, expiresAt: true, currentWordSetId: true },
  });
